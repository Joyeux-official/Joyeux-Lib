...
public class JoyeuxLibRecipeProvider  extends FabricRecipeProvider {
    ...
    public JoyeuxLibRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    private Identifier getStonecuttingIdentifier(Block in, Block out) {
        return JoyeuxLib.id(fixupBlockKey(in.getTranslationKey()) + "_to_" + fixupBlockKey(out.getTranslationKey()) + "_stonecutting");
    }
